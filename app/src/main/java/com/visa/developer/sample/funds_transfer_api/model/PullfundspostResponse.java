...
public class PullfundspostResponse {
    ...
    public PullfundspostResponse transactionIdentifier(Long transactionIdentifier) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(networkId, approvalCode, feeProgramIndicator, last4ofPAN, merchantVerificationValue, cavvResultCode, statusIdentifier, transactionIdentifier, memberComments, responseCode, actionCode, cpsAuthorizationCharacteristicsIndicator, reimbursementAttribute, transmissionDateTime);
    }
